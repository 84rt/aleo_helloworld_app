...
async function localProgramExecution(program, aleoFunction, inputs) {
  const programManager = new ProgramMahttps://github.com/AleoHQ/sdk/tree/testnet3/create-aleo-appnager();
...
async function deployProgram(program) {
  ...
  const account = new Account({
    privateKey: "APrivateKey1zkpGNbRbDFPQnBqRLnLZMUbfuQ2o3L2G3wHDwAHnyjjHHz2",
  });
